...
<body class="animsition">
    <?php include ('navbar.php'); ?>  
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <?php 
                $queryInSlip = "SELECT * FROM slip LEFT JOIN priority on slip.priorityID = priority.priorityID LEFT JOIN type on slip.typeID = type.typeID LEFT JOIN office on slip.officeID = office.officeID LEFT JOIN routing on slip.slipID = routing.slipID WHERE routing.status = 'In'";
