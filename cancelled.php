...
<body class="animsition">
    <?php include ('navbar.php'); ?>  
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <?php 
                $queryCanSlip = "SELECT * FROM slip LEFT JOIN priority on slip.priorityID = priority.priorityID LEFT JOIN type on slip.typeID = type.typeID LEFT JOIN office on slip.officeID = office.officeID";
