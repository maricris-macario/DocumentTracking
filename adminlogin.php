                ...
                <form class="form" action="login_admin.php" method="POST">
                    ...
                    <div>
                        <div class="form-group <?php echo(!empty($password_err)) ? 'has error' : ''; ?>">
                            ...
                            <input type="password" name="adminpass" class="form-control" placeholder="Password"><br><br>

                            <div class="form-group"><center><input class="btn btn-primary" type="submit" name="submit" value="LOGIN" action=""></center></div>
                        </div>
                    </div>
                </div>
                <center><h6 class="upp">Forgot password? <br>Please call the COMPUTER OFFICE @ local 6618. Thank you!</h6></center>
            </form>
        </div>
    </div>
</div>
