...
<body class="animsition">
    <?php include ('navbar.php'); ?>  
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <?php 
                $queryApSlip = "SELECT * FROM slip LEFT JOIN priority on slip.priorityID = priority.priorityID LEFT JOIN type on slip.typeID = type.typeID LEFT JOIN office on slip.officeID = office.officeID";
                            ...
                            <div class="col-sm-12 col-lg">
                                <div class="row">
                                    ...
                                    <!--div class="table table-data2 table-responsive"-->
                                        <table class="table table-bordered table-condensed  text-center" id="apSlip">
                                        <!--table class="table table-striped table-bordered table-hover" id="slip"-->
                                            ...
                                            <tbody>
                                                <?php 
                                                    if(mysqli_num_rows($getApSlip) > 0){
                                                    while ($slip = mysqli_fetch_assoc($getApSlip)) {
                                                ?>
                                                <tr>
